...
```
    ...
    Stacktrace:
     ...
     [2] parse_fasta(::Type{DNAAlphabet{4}}, ::String) at ./In[15]:16
...
```
    ...
    Stacktrace:
     ...
     [2] parse_newick(::String) at ./In[36]:8

     [3] top-level scope at In[37]:2
